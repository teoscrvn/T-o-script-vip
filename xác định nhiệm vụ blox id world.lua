...
-- ========== CHECK QUEST (ĐẦY ĐỦ WORLD 1,2,3) ==========
function CheckQuest()
    ...
    if World1 then
        ...
        if lv >= 650 then return "Galley Captain",2,"FountainQuest","Galley Captain",CFrame.new(5259.82,37.35,4050.03),CFrame.new(5441.95,42.50,4950.09) end
    -- WORLD 2
    elseif World2 then
        ...
        if lv >= 1450 then return "Water Fighter",2,"ForgottenQuest","Water Fighter",CFrame.new(-3054.44,235.54,-10142.82),CFrame.new(-3352.90,285.02,-10534.84) end
    -- WORLD 3
    elseif World3 then
